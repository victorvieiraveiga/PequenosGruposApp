...
//
//                    let participante = Participante(nome: nome, endereco: endereco, email: email, telefone: telefone, dataNascimento: dtNascimento, idCelula: idCelula, idParticipante: idParticipante)
