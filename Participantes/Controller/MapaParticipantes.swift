    ...
    func CarregaOutrasCelulas () {
       ...
       // let usuarioLogado = autenticacao.currentUser!.uid
        ...
        celulas.observe(DataEventType.childAdded) { (dataSnapshot) in
            ...
            let idCelula = celulaDados ["idCelula"]
            let idUsuario = celulaDados ["idUsuario"]
            
            self.celula = [Celulas(uidCelula: idCelula as! String, nomeLider: lider as! String, nomeAnfitriao: anfitriao as! String, endCelula: endereco as! String, diaCelula: dia as! String, horarioCelula: horario as! String, idUsuario: idUsuario as! String)]
